...
function displayResults(bmr, dej, activityLevel) {
    document.getElementById('bmr').innerHTML = `${bmr.toFixed(0)} kcal /jour Métabolisme de Base au Repos`;
    document.getElementById('dej').innerHTML = `${dej.toFixed(0)} kcal /jour Dépense Énergétique Journalière`;
    document.getElementById('nap').innerHTML = `${activityLevel.toFixed(2)} Niveau d'Activité Physique`;
}
